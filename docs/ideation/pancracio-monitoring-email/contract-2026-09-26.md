...
- [ ] web/app.py is untouched by this project — no new backend endpoint was needed — check: `test -z "$(git diff 6330337f447e111478c5bfcaf75dd17939df4ed4 -- web/app.py 2>/dev/null)"` → exits 0
